...
function infiniteQueryBehavior(pages2) {
  return {
    onFetch: (context, query) => {
      ...
      const fetchFn = async () => {
        ...
        if (direction && oldPages.length) {
          ...
          const remainingPages = pages2 ?? oldPages.length;
          do {
...
function getNextPageParam(options, { pages: pages2, pageParams }) {
  const lastIndex = pages2.length - 1;
  return pages2.length > 0 ? options.getNextPageParam(
    pages2[lastIndex],
    pages2,
...
function getPreviousPageParam(options, { pages: pages2, pageParams }) {
  var _a2;
  return pages2.length > 0 ? (_a2 = options.getPreviousPageParam) == null ? void 0 : _a2.call(options, pages2[0], pages2, pageParams[0], pageParams) : void 0;
}
...
const Type$1 = createLucideIcon("type", __iconNode);
const SITE_IMAGES = [
...
const assets = [
  {
    icon: /* @__PURE__ */ jsxRuntimeExports.jsx(FileCode, { size: 18 }),
    label: "8 HTML Pages",
    sub: "Pure static HTML5"
  },
  {
    icon: /* @__PURE__ */ jsxRuntimeExports.jsx(CodeXml, { size: 18 }),
    label: "1 CSS File",
    sub: "style.css (1,500+ lines)"
  },
  { icon: /* @__PURE__ */ jsxRuntimeExports.jsx(CodeXml, { size: 18 }), label: "1 JS File", sub: "jQuery 3.7 powered" },
  {
    icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Image, { size: 18 }),
    label: "11 AI Images",
    sub: "Hero + product banners"
  },
  { icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Type$1, { size: 18 }), label: "Google Fonts", sub: "Poppins (CDN)" },
  {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { display: "flex", gap: 14, alignItems: "flex-start" }, children: [
...
function App() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { display: "none" }, "aria-hidden": "true", children: SITE_IMAGES.map((src) => /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src, alt: "" }, src)) }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "header",
          {
            style: {
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "div",
                {
                  style: {
                    position: "absolute",
                    inset: 0,
                    background: "radial-gradient(circle at 20% 50%, rgba(39,174,96,0.1) 0%, transparent 60%), radial-gradient(circle at 80% 50%, rgba(232,163,32,0.08) 0%, transparent 60%)"
                  }
                }
              ),
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  ...
                  children: [
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "p",
                      {
                        ...
                        children: "Pure Static Website — HTML • CSS • jQuery • Fully Responsive"
                      }
                    ),
                    /* @__PURE__ */ jsxRuntimeExports.jsxs(
                      "div",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("main", { style: { maxWidth: 1100, margin: "0 auto", padding: "40px 20px" }, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { style: { marginBottom: 50 }, children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "div",
              {
                style: {
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(Globe, { size: 22, color: "#1B3A7A" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "h2",
                    {
                      style: {
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "span",
                    {
                      ...
                      children: "Click to open each page"
                    }
                  )
                ]
              }
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "div",
              {
                ...
                children: pages.map((page) => /* @__PURE__ */ jsxRuntimeExports.jsx(PageCard, { page }, page.name))
              }
            )
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { style: { marginBottom: 50 }, children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "div",
              {
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(Download, { size: 22, color: "#27AE60" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "h2",
                    {
                      style: {
                      ...
                      children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsxs(
                          "div",
                          {
                            ...
                            children: [
                              /* @__PURE__ */ jsxRuntimeExports.jsx(Github, { size: 26, color: "#0D1B3E" }),
                              /* @__PURE__ */ jsxRuntimeExports.jsx(
                                "h3",
                                {
                                  style: {
                        ...
                        /* @__PURE__ */ jsxRuntimeExports.jsx(
                          "p",
                          {
                            ...
                            children: "Export the full project to GitHub, then download the ZIP with all source files."
                          }
                        ),
                        /* @__PURE__ */ jsxRuntimeExports.jsxs(
                          "ol",
                          {
                            ...
                            children: [
                              /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { children: [
                                "Click ",
                                /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: '"Export to GitHub"' }),
                                " in Caffeine project settings"
                              ] }),
                              /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: "Connect your GitHub account and name the repository" }),
                              /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { children: [
                                "On GitHub, click ",
                                /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: "Code → Download ZIP" })
                              ] }),
                              /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { children: [
                                ...
                                /* @__PURE__ */ jsxRuntimeExports.jsx(
                                  "code",
                                  {
                                    ...
                                    children: "src/frontend/public/site/"
                                  }
                                )
                              ] }),
                              /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { children: [
                      ...
                      children: [
                        ...
                        /* @__PURE__ */ jsxRuntimeExports.jsx(
                          "div",
                          {
                            ...
                            children: assets.map((a) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                              "div",
                              {
                                style: {
                                  display: "flex",
                                ...
                                children: [
                                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { color: "#1B3A7A", marginTop: 2 }, children: a.icon }),
                                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                                      "div",
                                      {
                                    ...
                                    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { fontSize: "0.75rem", color: "#6c757d" }, children: a.sub })
                                  ] })
                                ]
                              },
                              a.label
                        ...
                        /* @__PURE__ */ jsxRuntimeExports.jsxs(
                          "div",
                          {
                            ...
                            children: [
                              /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: "Works offline:" }),
                              " Open ",
                              /* @__PURE__ */ jsxRuntimeExports.jsx("code", { children: "index.html" }),
                              " ",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { style: { color: "#1B3A7A" }, children: "Shikhar IMF Pvt. Ltd." }),
                " ",
                "• IRDAI Approved Insurance Marketing Firm • Pune, Maharashtra",
                /* @__PURE__ */ jsxRuntimeExports.jsx("br", {}),
                "Office No-1311/12, Boulevard Towers, 13th Floor, Sadhu Vaswani Chowk, Camp, Pune 411001",
                /* @__PURE__ */ jsxRuntimeExports.jsx("br", {}),
                /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: "tel:+919356633524", style: { color: "#1B3A7A" }, children: "+91 9356633524" }),
                " ",
                "•",
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "a",
...
const Time = Int;
const AdvisorApplication = Record({
  "name": Text,
  "email": Text,
  "experience": Text,
  "timestamp": Time,
...
Service({
  "getAllAdvisorApplications": Func(
    [],
    [Vec(AdvisorApplication)],
    ["query"]
  ),
  "getAllContactForms": Func([], [Vec(ContactForm)], ["query"]),
  "submitAdvisorApplication": Func([AdvisorApplication], [], []),
  "submitContactForm": Func([ContactForm], [], [])
});
