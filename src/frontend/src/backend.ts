...
export class Backend implements backendInterface {
    ...
    async getAllAdvisorApplications(): Promise<Array<AdvisorApplication>> {
        if (this.processError) {
            try {
                const result = await this.actor.getAllAdvisorApplications();
                return result;
            } catch (e) {
                this.processError(e);
    ...
    async submitAdvisorApplication(arg0: AdvisorApplication): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.submitAdvisorApplication(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
